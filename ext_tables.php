...
$TCA['tx_event_domain_model_event'] = array(
	'ctrl' => array(
		...
		'searchFields' => 'title,subtitle,short_title,teaser,description,image,files,start,end,all_day,fee,view,category,primary_calendar,secundary_calendar,register,link,location,organizer,',
